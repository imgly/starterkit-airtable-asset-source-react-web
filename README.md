...
Build a design editor with integrated [Airtable](https://airtable.com/) as a custom image asset source — use your Airtable database to manage and browse images directly within your editor. Built with [CE.SDK](https://img.ly/creative-sdk) by [IMG.LY](https://img.ly), runs entirely in the browser with no server dependencies.

<p>
  <a href="https://img.ly/docs/cesdk/starterkits/airtable-image-editor/">Documentation</a> |
...
```bash
git clone https://github.com/imgly/starterkit-airtable-image-editor-react-web.git
cd starterkit-airtable-image-editor-react-web
```
...
│       └── plugins/
│           └── airtable.ts   # Airtable asset source plugin
